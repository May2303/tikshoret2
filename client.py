...
def client(server_address: tuple[str, int], expression: api.Expression, show_steps: bool = True, cache_result: bool = True, cache_control: int = api.CalculatorHeader.MAX_CACHE_CONTROL) -> None:
